...
void OpcodeStore::BuildOpcodeList()
{
    ...
    /*0x04A*/  StoreOpcode(CMSG_PLAYER_LOGOUT,                "CMSG_PLAYER_LOGOUT",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePlayerLogoutOpcode);
    /*0x04B*/  StoreOpcode(CMSG_LOGOUT_REQUEST,               "CMSG_LOGOUT_REQUEST",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLogoutRequestOpcode);
    ...
    /*0x04E*/  StoreOpcode(CMSG_LOGOUT_CANCEL,                "CMSG_LOGOUT_CANCEL",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLogoutCancelOpcode);
    ...
    /*0x050*/  StoreOpcode(CMSG_NAME_QUERY,                   "CMSG_NAME_QUERY",                  STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleNameQueryOpcode);
    ...
    /*0x052*/  StoreOpcode(CMSG_PET_NAME_QUERY,               "CMSG_PET_NAME_QUERY",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetNameQueryOpcode);
    ...
    /*0x064*/  StoreOpcode(CMSG_WHOIS,                        "CMSG_WHOIS",                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleWhoisOpcode);
    ...
    /*0x06E*/  StoreOpcode(CMSG_GROUP_INVITE,                 "CMSG_GROUP_INVITE",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupInviteOpcode);
    ...
    /*0x072*/  StoreOpcode(CMSG_GROUP_ACCEPT,                 "CMSG_GROUP_ACCEPT",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupAcceptOpcode);
    /*0x073*/  StoreOpcode(CMSG_GROUP_DECLINE,                "CMSG_GROUP_DECLINE",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupDeclineOpcode);
    /*0x074*/  StoreOpcode(SMSG_GROUP_DECLINE,                "SMSG_GROUP_DECLINE",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x075*/  StoreOpcode(CMSG_GROUP_UNINVITE,               "CMSG_GROUP_UNINVITE",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupUninviteOpcode);
    /*0x076*/  StoreOpcode(CMSG_GROUP_UNINVITE_GUID,          "CMSG_GROUP_UNINVITE_GUID",         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupUninviteGuidOpcode);
    /*0x077*/  StoreOpcode(SMSG_GROUP_UNINVITE,               "SMSG_GROUP_UNINVITE",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x078*/  StoreOpcode(CMSG_GROUP_SET_LEADER,             "CMSG_GROUP_SET_LEADER",            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupSetLeaderOpcode);
    ...
    /*0x07A*/  StoreOpcode(CMSG_LOOT_METHOD,                  "CMSG_LOOT_METHOD",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootMethodOpcode);
    /*0x07B*/  StoreOpcode(CMSG_GROUP_DISBAND,                "CMSG_GROUP_DISBAND",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupDisbandOpcode);
    ...
    /*0x07E*/  StoreOpcode(SMSG_PARTY_MEMBER_STATS,           "SMSG_PARTY_MEMBER_STATS",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x07F*/  StoreOpcode(SMSG_PARTY_COMMAND_RESULT,         "SMSG_PARTY_COMMAND_RESULT",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x081*/  StoreOpcode(CMSG_GUILD_CREATE,                 "CMSG_GUILD_CREATE",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildCreateOpcode);
    /*0x082*/  StoreOpcode(CMSG_GUILD_INVITE,                 "CMSG_GUILD_INVITE",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildInviteOpcode);
    /*0x083*/  StoreOpcode(SMSG_GUILD_INVITE,                 "SMSG_GUILD_INVITE",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x084*/  StoreOpcode(CMSG_GUILD_ACCEPT,                 "CMSG_GUILD_ACCEPT",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildAcceptOpcode);
    /*0x085*/  StoreOpcode(CMSG_GUILD_DECLINE,                "CMSG_GUILD_DECLINE",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDeclineOpcode);
    /*0x086*/  StoreOpcode(SMSG_GUILD_DECLINE,                "SMSG_GUILD_DECLINE",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x087*/  StoreOpcode(CMSG_GUILD_INFO,                   "CMSG_GUILD_INFO",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildInfoOpcode);
    /*0x088*/  StoreOpcode(SMSG_GUILD_INFO,                   "SMSG_GUILD_INFO",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x089*/  StoreOpcode(CMSG_GUILD_ROSTER,                 "CMSG_GUILD_ROSTER",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildRosterOpcode);
    /*0x08A*/  StoreOpcode(SMSG_GUILD_ROSTER,                 "SMSG_GUILD_ROSTER",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x08B*/  StoreOpcode(CMSG_GUILD_PROMOTE,                "CMSG_GUILD_PROMOTE",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildPromoteOpcode);
    /*0x08C*/  StoreOpcode(CMSG_GUILD_DEMOTE,                 "CMSG_GUILD_DEMOTE",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDemoteOpcode);
    /*0x08D*/  StoreOpcode(CMSG_GUILD_LEAVE,                  "CMSG_GUILD_LEAVE",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildLeaveOpcode);
    /*0x08E*/  StoreOpcode(CMSG_GUILD_REMOVE,                 "CMSG_GUILD_REMOVE",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildRemoveOpcode);
    /*0x08F*/  StoreOpcode(CMSG_GUILD_DISBAND,                "CMSG_GUILD_DISBAND",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDisbandOpcode);
    /*0x090*/  StoreOpcode(CMSG_GUILD_LEADER,                 "CMSG_GUILD_LEADER",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildLeaderOpcode);
    /*0x091*/  StoreOpcode(CMSG_GUILD_MOTD,                   "CMSG_GUILD_MOTD",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildMOTDOpcode);
    ...
    /*0x097*/  StoreOpcode(CMSG_JOIN_CHANNEL,                 "CMSG_JOIN_CHANNEL",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleJoinChannelOpcode);
    /*0x098*/  StoreOpcode(CMSG_LEAVE_CHANNEL,                "CMSG_LEAVE_CHANNEL",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLeaveChannelOpcode);
    /*0x099*/  StoreOpcode(SMSG_CHANNEL_NOTIFY,               "SMSG_CHANNEL_NOTIFY",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x09A*/  StoreOpcode(CMSG_CHANNEL_LIST,                 "CMSG_CHANNEL_LIST",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelListOpcode);
    /*0x09B*/  StoreOpcode(SMSG_CHANNEL_LIST,                 "SMSG_CHANNEL_LIST",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x09C*/  StoreOpcode(CMSG_CHANNEL_PASSWORD,             "CMSG_CHANNEL_PASSWORD",            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelPasswordOpcode);
    /*0x09D*/  StoreOpcode(CMSG_CHANNEL_SET_OWNER,            "CMSG_CHANNEL_SET_OWNER",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelSetOwnerOpcode);
    /*0x09E*/  StoreOpcode(CMSG_CHANNEL_OWNER,                "CMSG_CHANNEL_OWNER",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelOwnerOpcode);
    /*0x09F*/  StoreOpcode(CMSG_CHANNEL_MODERATOR,            "CMSG_CHANNEL_MODERATOR",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelModeratorOpcode);
    /*0x0A0*/  StoreOpcode(CMSG_CHANNEL_UNMODERATOR,          "CMSG_CHANNEL_UNMODERATOR",         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelUnmoderatorOpcode);
    /*0x0A1*/  StoreOpcode(CMSG_CHANNEL_MUTE,                 "CMSG_CHANNEL_MUTE",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelMuteOpcode);
    /*0x0A2*/  StoreOpcode(CMSG_CHANNEL_UNMUTE,               "CMSG_CHANNEL_UNMUTE",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelUnmuteOpcode);
    /*0x0A3*/  StoreOpcode(CMSG_CHANNEL_INVITE,               "CMSG_CHANNEL_INVITE",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelInviteOpcode);
    /*0x0A4*/  StoreOpcode(CMSG_CHANNEL_KICK,                 "CMSG_CHANNEL_KICK",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelKickOpcode);
    /*0x0A5*/  StoreOpcode(CMSG_CHANNEL_BAN,                  "CMSG_CHANNEL_BAN",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelBanOpcode);
    /*0x0A6*/  StoreOpcode(CMSG_CHANNEL_UNBAN,                "CMSG_CHANNEL_UNBAN",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelUnbanOpcode);
    /*0x0A7*/  StoreOpcode(CMSG_CHANNEL_ANNOUNCEMENTS,        "CMSG_CHANNEL_ANNOUNCEMENTS",       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelAnnouncementsOpcode);
    /*0x0A8*/  StoreOpcode(CMSG_CHANNEL_MODERATE,             "CMSG_CHANNEL_MODERATE",            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelModerateOpcode);
    ...
    /*0x0AC*/  StoreOpcode(CMSG_OPEN_ITEM,                    "CMSG_OPEN_ITEM",                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleOpenItemOpcode);
    /*0x0AD*/  StoreOpcode(CMSG_READ_ITEM,                    "CMSG_READ_ITEM",                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleReadItemOpcode);
    ...
    /*0x0B1*/  StoreOpcode(CMSG_GAMEOBJ_USE,                  "CMSG_GAMEOBJ_USE",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGameObjectUseOpcode);
    ...
    /*0x0B4*/  StoreOpcode(CMSG_AREATRIGGER,                  "CMSG_AREATRIGGER",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE,      &WorldSession::HandleAreaTriggerOpcode);
    ...
    /*0x0D8*/  StoreOpcode(MSG_MOVE_SET_TURN_RATE,            "MSG_MOVE_SET_TURN_RATE",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    ...
    /*0x0EF*/  StoreOpcode(SMSG_MOVE_KNOCK_BACK,              "SMSG_MOVE_KNOCK_BACK",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x0F0*/  StoreOpcode(CMSG_MOVE_KNOCK_BACK_ACK,          "CMSG_MOVE_KNOCK_BACK_ACK",         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveKnockBackAck);
    /*0x0F1*/  StoreOpcode(MSG_MOVE_KNOCK_BACK,               "MSG_MOVE_KNOCK_BACK",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    ...
    /*0x102*/  StoreOpcode(CMSG_EMOTE,                        "CMSG_EMOTE",                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleEmoteOpcode);
    /*0x103*/  StoreOpcode(SMSG_EMOTE,                        "SMSG_EMOTE",                       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x104*/  StoreOpcode(CMSG_TEXT_EMOTE,                   "CMSG_TEXT_EMOTE",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTextEmoteOpcode);
    ...
    /*0x113*/  StoreOpcode(SMSG_OPEN_CONTAINER,               "SMSG_OPEN_CONTAINER",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x116*/  StoreOpcode(CMSG_INITIATE_TRADE,               "CMSG_INITIATE_TRADE",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleInitiateTradeOpcode);
    /*0x117*/  StoreOpcode(CMSG_BEGIN_TRADE,                  "CMSG_BEGIN_TRADE",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBeginTradeOpcode);
    /*0x118*/  StoreOpcode(CMSG_BUSY_TRADE,                   "CMSG_BUSY_TRADE",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBusyTradeOpcode);
    /*0x119*/  StoreOpcode(CMSG_IGNORE_TRADE,                 "CMSG_IGNORE_TRADE",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleIgnoreTradeOpcode);
    /*0x11A*/  StoreOpcode(CMSG_ACCEPT_TRADE,                 "CMSG_ACCEPT_TRADE",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAcceptTradeOpcode);
    /*0x11B*/  StoreOpcode(CMSG_UNACCEPT_TRADE,               "CMSG_UNACCEPT_TRADE",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleUnacceptTradeOpcode);
    /*0x11C*/  StoreOpcode(CMSG_CANCEL_TRADE,                 "CMSG_CANCEL_TRADE",                STATUS_LOGGEDIN_OR_RECENTLY_LOGGEDOUT, PROCESS_THREADUNSAFE, &WorldSession::HandleCancelTradeOpcode);
    /*0x11D*/  StoreOpcode(CMSG_SET_TRADE_ITEM,               "CMSG_SET_TRADE_ITEM",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetTradeItemOpcode);
    /*0x11E*/  StoreOpcode(CMSG_CLEAR_TRADE_ITEM,             "CMSG_CLEAR_TRADE_ITEM",            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleClearTradeItemOpcode);
    /*0x11F*/  StoreOpcode(CMSG_SET_TRADE_GOLD,               "CMSG_SET_TRADE_GOLD",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetTradeGoldOpcode);
    ...
    /*0x130*/  StoreOpcode(SMSG_CAST_RESULT,                  "SMSG_CAST_RESULT",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x136*/  StoreOpcode(CMSG_CANCEL_AURA,                  "CMSG_CANCEL_AURA",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCancelAuraOpcode);
    ...
    /*0x13B*/  StoreOpcode(CMSG_CANCEL_CHANNELLING,           "CMSG_CANCEL_CHANNELLING",          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCancelChanneling);
    /*0x13C*/  StoreOpcode(SMSG_AI_REACTION,                  "SMSG_AI_REACTION",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x13D*/  StoreOpcode(CMSG_SET_SELECTION,                "CMSG_SET_SELECTION",               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetSelectionOpcode);
    /*0x13E*/  StoreOpcode(CMSG_SET_TARGET_OBSOLETE,          "CMSG_SET_TARGET_OBSOLETE",         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetTargetOpcode);
    ...
    /*0x141*/  StoreOpcode(CMSG_ATTACKSWING,                  "CMSG_ATTACKSWING",                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAttackSwingOpcode);
    /*0x142*/  StoreOpcode(CMSG_ATTACKSTOP,                   "CMSG_ATTACKSTOP",                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAttackStopOpcode);
    ...
    /*0x14B*/  StoreOpcode(SMSG_VICTIMSTATEUPDATE_OBSOLETE,   "SMSG_VICTIMSTATEUPDATE_OBSOLETE",  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x14C*/  StoreOpcode(SMSG_DAMAGE_DONE_OBSOLETE,         "SMSG_DAMAGE_DONE_OBSOLETE",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x14D*/  StoreOpcode(SMSG_DAMAGE_TAKEN_OBSOLETE,        "SMSG_DAMAGE_TAKEN_OBSOLETE",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x14E*/  StoreOpcode(SMSG_CANCEL_COMBAT,                "SMSG_CANCEL_COMBAT",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x14F*/  StoreOpcode(SMSG_PLAYER_COMBAT_XP_GAIN_OBSOLETE,    "SMSG_PLAYER_COMBAT_XP_GAIN_OBSOLETE",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x157*/  StoreOpcode(SMSG_BINDZONEREPLY,                "SMSG_BINDZONEREPLY",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x15A*/  StoreOpcode(CMSG_REPOP_REQUEST,                "CMSG_REPOP_REQUEST",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRepopRequestOpcode);
    ...
    /*0x15D*/  StoreOpcode(CMSG_LOOT,                         "CMSG_LOOT",                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootOpcode);
    /*0x15E*/  StoreOpcode(CMSG_LOOT_MONEY,                   "CMSG_LOOT_MONEY",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootMoneyOpcode);
    /*0x15F*/  StoreOpcode(CMSG_LOOT_RELEASE,                 "CMSG_LOOT_RELEASE",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootReleaseOpcode);
    ...
    /*0x16C*/  StoreOpcode(CMSG_DUEL_ACCEPTED,                "CMSG_DUEL_ACCEPTED",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDuelAcceptedOpcode);
    /*0x16D*/  StoreOpcode(CMSG_DUEL_CANCELLED,               "CMSG_DUEL_CANCELLED",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDuelCancelledOpcode);
    ...
    /*0x170*/  StoreOpcode(SMSG_PUREMOUNT_CANCELLED_OBSOLETE, "SMSG_PUREMOUNT_CANCELLED_OBSOLETE", STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x171*/  StoreOpcode(CMSG_MOUNTSPECIAL_ANIM,            "CMSG_MOUNTSPECIAL_ANIM",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMountSpecialAnimOpcode);
    ...
    /*0x174*/  StoreOpcode(CMSG_PET_SET_ACTION,               "CMSG_PET_SET_ACTION",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetSetAction);
    /*0x175*/  StoreOpcode(CMSG_PET_ACTION,                   "CMSG_PET_ACTION",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetAction);
    /*0x176*/  StoreOpcode(CMSG_PET_ABANDON,                  "CMSG_PET_ABANDON",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetAbandon);
    /*0x177*/  StoreOpcode(CMSG_PET_RENAME,                   "CMSG_PET_RENAME",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetRename);
    ...
    /*0x17B*/  StoreOpcode(CMSG_GOSSIP_HELLO,                 "CMSG_GOSSIP_HELLO",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGossipHelloOpcode);
    /*0x17C*/  StoreOpcode(CMSG_GOSSIP_SELECT_OPTION,         "CMSG_GOSSIP_SELECT_OPTION",        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGossipSelectOptionOpcode);
    ...
    /*0x17F*/  StoreOpcode(CMSG_NPC_TEXT_QUERY,               "CMSG_NPC_TEXT_QUERY",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNpcTextQueryOpcode);
    /*0x180*/  StoreOpcode(SMSG_NPC_TEXT_UPDATE,              "SMSG_NPC_TEXT_UPDATE",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x181*/  StoreOpcode(SMSG_NPC_WONT_TALK,                "SMSG_NPC_WONT_TALK",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x182*/  StoreOpcode(CMSG_QUESTGIVER_STATUS_QUERY,      "CMSG_QUESTGIVER_STATUS_QUERY",     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverStatusQueryOpcode);
    ...
    /*0x184*/  StoreOpcode(CMSG_QUESTGIVER_HELLO,             "CMSG_QUESTGIVER_HELLO",            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverHelloOpcode);
    ...
    /*0x186*/  StoreOpcode(CMSG_QUESTGIVER_QUERY_QUEST,       "CMSG_QUESTGIVER_QUERY_QUEST",      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverQueryQuestOpcode);
    /*0x187*/  StoreOpcode(CMSG_QUESTGIVER_QUEST_AUTOLAUNCH,  "CMSG_QUESTGIVER_QUEST_AUTOLAUNCH", STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverQuestAutoLaunch);
    ...
    /*0x189*/  StoreOpcode(CMSG_QUESTGIVER_ACCEPT_QUEST,      "CMSG_QUESTGIVER_ACCEPT_QUEST",     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverAcceptQuestOpcode);
    /*0x18A*/  StoreOpcode(CMSG_QUESTGIVER_COMPLETE_QUEST,    "CMSG_QUESTGIVER_COMPLETE_QUEST",   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverCompleteQuest);
    ...
    /*0x18C*/  StoreOpcode(CMSG_QUESTGIVER_REQUEST_REWARD,    "CMSG_QUESTGIVER_REQUEST_REWARD",   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverRequestRewardOpcode);
    ...
    /*0x18E*/  StoreOpcode(CMSG_QUESTGIVER_CHOOSE_REWARD,     "CMSG_QUESTGIVER_CHOOSE_REWARD",    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverChooseRewardOpcode);
    ...
    /*0x190*/  StoreOpcode(CMSG_QUESTGIVER_CANCEL,            "CMSG_QUESTGIVER_CANCEL",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverCancel);
    ...
    /*0x193*/  StoreOpcode(CMSG_QUESTLOG_SWAP_QUEST,          "CMSG_QUESTLOG_SWAP_QUEST",         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestLogSwapQuest);
    /*0x194*/  StoreOpcode(CMSG_QUESTLOG_REMOVE_QUEST,        "CMSG_QUESTLOG_REMOVE_QUEST",       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestLogRemoveQuest);
    ...
    /*0x19B*/  StoreOpcode(CMSG_QUEST_CONFIRM_ACCEPT,         "CMSG_QUEST_CONFIRM_ACCEPT",        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestConfirmAccept);
    ...
    /*0x19D*/  StoreOpcode(CMSG_PUSHQUESTTOPARTY,             "CMSG_PUSHQUESTTOPARTY",            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePushQuestToParty);
    /*0x19E*/  StoreOpcode(CMSG_LIST_INVENTORY,               "CMSG_LIST_INVENTORY",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleListInventoryOpcode);
    /*0x19F*/  StoreOpcode(SMSG_LIST_INVENTORY,               "SMSG_LIST_INVENTORY",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x1A0*/  StoreOpcode(CMSG_SELL_ITEM,                    "CMSG_SELL_ITEM",                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSellItemOpcode);
    /*0x1A1*/  StoreOpcode(SMSG_SELL_ITEM,                    "SMSG_SELL_ITEM",                   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x1A2*/  StoreOpcode(CMSG_BUY_ITEM,                     "CMSG_BUY_ITEM",                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBuyItemOpcode);
    /*0x1A3*/  StoreOpcode(CMSG_BUY_ITEM_IN_SLOT,             "CMSG_BUY_ITEM_IN_SLOT",            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBuyItemInSlotOpcode);
    ...
    /*0x1AA*/  StoreOpcode(CMSG_TAXINODE_STATUS_QUERY,        "CMSG_TAXINODE_STATUS_QUERY",       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTaxiNodeStatusQueryOpcode);
    /*0x1AB*/  StoreOpcode(SMSG_TAXINODE_STATUS,              "SMSG_TAXINODE_STATUS",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x1AC*/  StoreOpcode(CMSG_TAXIQUERYAVAILABLENODES,      "CMSG_TAXIQUERYAVAILABLENODES",     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTaxiQueryAvailableNodes);
    /*0x1AD*/  StoreOpcode(CMSG_ACTIVATETAXI,                 "CMSG_ACTIVATETAXI",                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleActivateTaxiOpcode);
    ...
    /*0x1B0*/  StoreOpcode(CMSG_TRAINER_LIST,                 "CMSG_TRAINER_LIST",                STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleTrainerListOpcode);
    /*0x1B1*/  StoreOpcode(SMSG_TRAINER_LIST,                 "SMSG_TRAINER_LIST",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x1B2*/  StoreOpcode(CMSG_TRAINER_BUY_SPELL,            "CMSG_TRAINER_BUY_SPELL",           STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleTrainerBuySpellOpcode);
    /*0x1B3*/  StoreOpcode(SMSG_TRAINER_BUY_SUCCEEDED,        "SMSG_TRAINER_BUY_SUCCEEDED",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x1B5*/  StoreOpcode(CMSG_BINDER_ACTIVATE,              "CMSG_BINDER_ACTIVATE",             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleBinderActivateOpcode);
    /*0x1B6*/  StoreOpcode(SMSG_PLAYERBINDERROR,              "SMSG_PLAYERBINDERROR",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x1B7*/  StoreOpcode(CMSG_BANKER_ACTIVATE,              "CMSG_BANKER_ACTIVATE",             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleBankerActivateOpcode);
    ...
    /*0x1BB*/  StoreOpcode(CMSG_PETITION_SHOWLIST,            "CMSG_PETITION_SHOWLIST",           STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandlePetitionShowListOpcode);
    ...
    /*0x1BD*/  StoreOpcode(CMSG_PETITION_BUY,                 "CMSG_PETITION_BUY",                STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandlePetitionBuyOpcode);
    /*0x1BE*/  StoreOpcode(CMSG_PETITION_SHOW_SIGNATURES,     "CMSG_PETITION_SHOW_SIGNATURES",    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandlePetitionShowSignOpcode);
    ...
    /*0x1C0*/  StoreOpcode(CMSG_PETITION_SIGN,                "CMSG_PETITION_SIGN",               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandlePetitionSignOpcode);
    ...
    /*0x1C3*/  StoreOpcode(CMSG_OFFER_PETITION,               "CMSG_OFFER_PETITION",              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleOfferPetitionOpcode);
    /*0x1C4*/  StoreOpcode(CMSG_TURN_IN_PETITION,             "CMSG_TURN_IN_PETITION",            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleTurnInPetitionOpcode);
    ...
    /*0x1C6*/  StoreOpcode(CMSG_PETITION_QUERY,               "CMSG_PETITION_QUERY",              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandlePetitionQueryOpcode);
    ...
    /*0x1CA*/  StoreOpcode(CMSG_BUG,                          "CMSG_BUG",                         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleBugOpcode);
    /*0x1CB*/  StoreOpcode(SMSG_NOTIFICATION,                 "SMSG_NOTIFICATION",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x1CC*/  StoreOpcode(CMSG_PLAYED_TIME,                  "CMSG_PLAYED_TIME",                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandlePlayedTime);
    /*0x1CD*/  StoreOpcode(SMSG_PLAYED_TIME,                  "SMSG_PLAYED_TIME",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x1CE*/  StoreOpcode(CMSG_QUERY_TIME,                   "CMSG_QUERY_TIME",                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleQueryTimeOpcode);
    ...
    /*0x1D1*/  StoreOpcode(SMSG_AURACASTLOG,                  "SMSG_AURACASTLOG",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x1D3*/  StoreOpcode(CMSG_WRAP_ITEM,                    "CMSG_WRAP_ITEM",                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleWrapItemOpcode);
    ...
    /*0x1DC*/  StoreOpcode(CMSG_PING,                         "CMSG_PING",                        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess);
    /*0x1DD*/  StoreOpcode(SMSG_PONG,                         "SMSG_PONG",                        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x1E0*/  StoreOpcode(CMSG_SETSHEATHED,                  "CMSG_SETSHEATHED",                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetSheathedOpcode);
    ...
    /*0x1E7*/  StoreOpcode(SMSG_INVALID_PROMOTION_CODE,       "SMSG_INVALID_PROMOTION_CODE",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x1F0*/  StoreOpcode(CMSG_PET_CAST_SPELL,               "CMSG_PET_CAST_SPELL",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetCastSpellOpcode);
    ...
    /*0x1F7*/  StoreOpcode(SMSG_PLAY_SPELL_IMPACT,            "SMSG_PLAY_SPELL_IMPACT",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x202*/  StoreOpcode(CMSG_UNLEARN_SKILL,                "CMSG_UNLEARN_SKILL",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleUnlearnSkillOpcode);
    ...
    /*0x205*/  StoreOpcode(CMSG_GMTICKET_CREATE,              "CMSG_GMTICKET_CREATE",             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketCreateOpcode);
    /*0x206*/  StoreOpcode(SMSG_GMTICKET_CREATE,              "SMSG_GMTICKET_CREATE",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x207*/  StoreOpcode(CMSG_GMTICKET_UPDATETEXT,          "CMSG_GMTICKET_UPDATETEXT",         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketUpdateTextOpcode);
    ...
    /*0x209*/  StoreOpcode(SMSG_ACCOUNT_DATA_TIMES,           "SMSG_ACCOUNT_DATA_TIMES",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x20A*/  StoreOpcode(CMSG_REQUEST_ACCOUNT_DATA,         "CMSG_REQUEST_ACCOUNT_DATA",        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRequestAccountData);
    /*0x20B*/  StoreOpcode(CMSG_UPDATE_ACCOUNT_DATA,          "CMSG_UPDATE_ACCOUNT_DATA",         STATUS_LOGGEDIN_OR_RECENTLY_LOGGEDOUT, PROCESS_THREADUNSAFE, &WorldSession::HandleUpdateAccountData);
    ...
    /*0x20E*/  StoreOpcode(SMSG_POWERGAINLOG_OBSOLETE,        "SMSG_POWERGAINLOG_OBSOLETE",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x214*/  StoreOpcode(SMSG_GAMEOBJECT_SPAWN_ANIM_OBSOLETE,    "SMSG_GAMEOBJECT_SPAWN_ANIM_OBSOLETE",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x216*/  StoreOpcode(MSG_CORPSE_QUERY,                  "MSG_CORPSE_QUERY",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCorpseQueryOpcode);
    /*0x217*/  StoreOpcode(CMSG_GMTICKET_DELETETICKET,        "CMSG_GMTICKET_DELETETICKET",       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketDeleteTicketOpcode);
    ...
    /*0x21A*/  StoreOpcode(CMSG_GMTICKET_SYSTEMSTATUS,        "CMSG_GMTICKET_SYSTEMSTATUS",       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketSystemStatusOpcode);
    ...
    /*0x21C*/  StoreOpcode(CMSG_SPIRIT_HEALER_ACTIVATE,       "CMSG_SPIRIT_HEALER_ACTIVATE",      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSpiritHealerActivateOpcode);
    ...
    /*0x225*/  StoreOpcode(CMSG_CHAT_IGNORED,                 "CMSG_CHAT_IGNORED",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChatIgnoredOpcode);
    ...
    /*0x231*/  StoreOpcode(CMSG_GUILD_RANK,                   "CMSG_GUILD_RANK",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildRankOpcode);
    /*0x232*/  StoreOpcode(CMSG_GUILD_ADD_RANK,               "CMSG_GUILD_ADD_RANK",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildAddRankOpcode);
    /*0x233*/  StoreOpcode(CMSG_GUILD_DEL_RANK,               "CMSG_GUILD_DEL_RANK",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDelRankOpcode);
    /*0x234*/  StoreOpcode(CMSG_GUILD_SET_PUBLIC_NOTE,        "CMSG_GUILD_SET_PUBLIC_NOTE",       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildSetPublicNoteOpcode);
    /*0x235*/  StoreOpcode(CMSG_GUILD_SET_OFFICER_NOTE,       "CMSG_GUILD_SET_OFFICER_NOTE",      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildSetOfficerNoteOpcode);
    ...
    /*0x238*/  StoreOpcode(CMSG_SEND_MAIL,                    "CMSG_SEND_MAIL",                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSendMail);
    ...
    /*0x23C*/  StoreOpcode(CMSG_BATTLEFIELD_LIST,             "CMSG_BATTLEFIELD_LIST",            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlefieldListOpcode);
    ...
    /*0x243*/  StoreOpcode(CMSG_ITEM_TEXT_QUERY,              "CMSG_ITEM_TEXT_QUERY",             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleItemTextQuery);
    ...
    /*0x24D*/  StoreOpcode(SMSG_DEBUGAURAPROC,                "SMSG_DEBUGAURAPROC",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x253*/  StoreOpcode(CMSG_TOGGLE_PVP,                   "CMSG_TOGGLE_PVP",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTogglePvP);
    ...
    /*0x259*/  StoreOpcode(CMSG_AUCTION_LIST_OWNER_ITEMS,     "CMSG_AUCTION_LIST_OWNER_ITEMS",    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionListOwnerItems);
    ...
    /*0x264*/  StoreOpcode(CMSG_AUCTION_LIST_BIDDER_ITEMS,    "CMSG_AUCTION_LIST_BIDDER_ITEMS",   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionListBidderItems);
    ...
    /*0x268*/  StoreOpcode(CMSG_SET_AMMO,                     "CMSG_SET_AMMO",                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetAmmoOpcode);
    ...
    /*0x26A*/  StoreOpcode(CMSG_SET_ACTIVE_MOVER,             "CMSG_SET_ACTIVE_MOVER",            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetActiveMoverOpcode);
    /*0x26B*/  StoreOpcode(CMSG_PET_CANCEL_AURA,              "CMSG_PET_CANCEL_AURA",             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetCancelAuraOpcode);
    /*0x26C*/  StoreOpcode(CMSG_PLAYER_AI_CHEAT,              "CMSG_PLAYER_AI_CHEAT",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x26D*/  StoreOpcode(CMSG_CANCEL_AUTO_REPEAT_SPELL,     "CMSG_CANCEL_AUTO_REPEAT_SPELL",    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCancelAutoRepeatSpellOpcode);
    ...
    /*0x271*/  StoreOpcode(CMSG_UNSTABLE_PET,                 "CMSG_UNSTABLE_PET",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleUnstablePet);
    /*0x272*/  StoreOpcode(CMSG_BUY_STABLE_SLOT,              "CMSG_BUY_STABLE_SLOT",             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBuyStableSlot);
    /*0x273*/  StoreOpcode(SMSG_STABLE_RESULT,                "SMSG_STABLE_RESULT",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x274*/  StoreOpcode(CMSG_STABLE_REVIVE_PET,            "CMSG_STABLE_REVIVE_PET",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleStableRevivePet);
    ...
    /*0x279*/  StoreOpcode(CMSG_REQUEST_PET_INFO,             "CMSG_REQUEST_PET_INFO",            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRequestPetInfoOpcode);
    /*0x27A*/  StoreOpcode(CMSG_FAR_SIGHT,                    "CMSG_FAR_SIGHT",                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleFarSightOpcode);
    ...
    /*0x28F*/  StoreOpcode(CMSG_GROUP_ASSISTANT_LEADER,       "CMSG_GROUP_ASSISTANT_LEADER",      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupAssistantLeaderOpcode);
    ...
    /*0x29B*/  StoreOpcode(CMSG_CANCEL_GROWTH_AURA,           "CMSG_CANCEL_GROWTH_AURA",          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCancelGrowthAuraOpcode);
    ...
    /*0x2A3*/  StoreOpcode(CMSG_LOOT_MASTER_GIVE,             "CMSG_LOOT_MASTER_GIVE",            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootMasterGiveOpcode);
    ...
    /*0x2A8*/  StoreOpcode(CMSG_REPAIR_ITEM,                  "CMSG_REPAIR_ITEM",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRepairItemOpcode);
    ...
    /*0x2AC*/  StoreOpcode(CMSG_SUMMON_RESPONSE,              "CMSG_SUMMON_RESPONSE",             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSummonResponseOpcode);
    ...
    /*0x2B3*/  StoreOpcode(CMSG_SELF_RES,                     "CMSG_SELF_RES",                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSelfResOpcode);
    ...
    /*0x2B6*/  StoreOpcode(SMSG_SCRIPT_MESSAGE,               "SMSG_SCRIPT_MESSAGE",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x2C4*/  StoreOpcode(CMSG_ITEM_NAME_QUERY,              "CMSG_ITEM_NAME_QUERY",             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleItemNameQueryOpcode);
    ...
    /*0x2C7*/  StoreOpcode(CMSG_CHAR_RENAME,                  "CMSG_CHAR_RENAME",                 STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharRenameOpcode);
    /*0x2C8*/  StoreOpcode(SMSG_CHAR_RENAME,                  "SMSG_CHAR_RENAME",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x2C9*/  StoreOpcode(CMSG_MOVE_SPLINE_DONE,             "CMSG_MOVE_SPLINE_DONE",            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveSplineDoneOpcode);
    ...
    /*0x2E2*/  StoreOpcode(CMSG_AREA_SPIRIT_HEALER_QUERY,     "CMSG_AREA_SPIRIT_HEALER_QUERY",    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAreaSpiritHealerQueryOpcode);
    /*0x2E3*/  StoreOpcode(CMSG_AREA_SPIRIT_HEALER_QUEUE,     "CMSG_AREA_SPIRIT_HEALER_QUEUE",    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAreaSpiritHealerQueueOpcode);
    ...
    /*0x2EE*/  StoreOpcode(CMSG_BATTLEMASTER_JOIN,            "CMSG_BATTLEMASTER_JOIN",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlemasterJoinOpcode);
    /*0x2EF*/  StoreOpcode(SMSG_ADDON_INFO,                   "SMSG_ADDON_INFO",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x2F0*/  StoreOpcode(CMSG_PET_UNLEARN,                  "CMSG_PET_UNLEARN",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetUnlearnOpcode);
    ...
    /*0x2F3*/  StoreOpcode(CMSG_PET_SPELL_AUTOCAST,           "CMSG_PET_SPELL_AUTOCAST",          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetSpellAutocastOpcode);
    ...
    /*0x2FC*/  StoreOpcode(CMSG_GUILD_INFO_TEXT,              "CMSG_GUILD_INFO_TEXT",             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildChangeInfoTextOpcode);
    ...
    /*0x312*/  StoreOpcode(CMSG_ACTIVATETAXIEXPRESS,          "CMSG_ACTIVATETAXIEXPRESS",         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleActivateTaxiExpressOpcode);
    ...
    /*0x314*/  StoreOpcode(SMSG_GAMETIMEBIAS_SET,             "SMSG_GAMETIMEBIAS_SET",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x317*/  StoreOpcode(CMSG_SET_FACTION_INACTIVE,         "CMSG_SET_FACTION_INACTIVE",        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetFactionInactiveOpcode);
    /*0x318*/  StoreOpcode(CMSG_SET_WATCHED_FACTION,          "CMSG_SET_WATCHED_FACTION",         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetWatchedFactionOpcode);
    ...
    /*0x31D*/  StoreOpcode(CMSG_RESET_INSTANCES,              "CMSG_RESET_INSTANCES",             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleResetInstancesOpcode);
    ...
    /*0x326*/  StoreOpcode(SMSG_GHOSTEE_GONE,                 "SMSG_GHOSTEE_GONE",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x338*/  StoreOpcode(SMSG_CHARACTER_PROFILE,            "SMSG_CHARACTER_PROFILE",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x339*/  StoreOpcode(SMSG_CHARACTER_PROFILE_REALM_CONNECTED, "SMSG_CHARACTER_PROFILE_REALM_CONNECTED",  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x33A*/  StoreOpcode(SMSG_DEFENSE_MESSAGE,              "SMSG_DEFENSE_MESSAGE",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    /*0x375*/  StoreOpcode(CMSG_CANCEL_MOUNT_AURA,            "CMSG_CANCEL_MOUNT_AURA",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCancelMountAuraOpcode);
    /*0x379*/  StoreOpcode(CMSG_CANCEL_TEMP_ENCHANTMENT,      "CMSG_CANCEL_TEMP_ENCHANTMENT",     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCancelTempEnchantmentOpcode);
    /*0x389*/  StoreOpcode(CMSG_SET_TAXI_BENCHMARK_MODE,      "CMSG_SET_TAXI_BENCHMARK_MODE",     STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleSetTaxiBenchmarkOpcode);
    /*0x38D*/  StoreOpcode(CMSG_MOVE_CHNG_TRANSPORT,          "CMSG_MOVE_CHNG_TRANSPORT",         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    /*0x38E*/  StoreOpcode(MSG_PARTY_ASSIGNMENT,              "MSG_PARTY_ASSIGNMENT",             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePartyAssignmentOpcode);
    /*0x38F*/  StoreOpcode(SMSG_OFFER_PETITION_ERROR,         "SMSG_OFFER_PETITION_ERROR",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x396*/  StoreOpcode(SMSG_RESET_FAILED_NOTIFY,          "SMSG_RESET_FAILED_NOTIFY",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x397*/  StoreOpcode(SMSG_REAL_GROUP_UPDATE,            "SMSG_REAL_GROUP_UPDATE",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3A3*/  StoreOpcode(SMSG_INIT_EXTRA_AURA_INFO,         "SMSG_INIT_EXTRA_AURA_INFO",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3A4*/  StoreOpcode(SMSG_SET_EXTRA_AURA_INFO,          "SMSG_SET_EXTRA_AURA_INFO",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3A5*/  StoreOpcode(SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE,   "SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE",    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3AA*/  StoreOpcode(SMSG_SPELL_CHANCE_PROC_LOG,        "SMSG_SPELL_CHANCE_PROC_LOG",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3AB*/  StoreOpcode(CMSG_MOVE_SET_RUN_SPEED,           "CMSG_MOVE_SET_RUN_SPEED",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x3AC*/  StoreOpcode(SMSG_DISMOUNT,                     "SMSG_DISMOUNT",                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3AE*/  StoreOpcode(MSG_RAID_READY_CHECK_CONFIRM,      "MSG_RAID_READY_CHECK_CONFIRM",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x3BE*/  StoreOpcode(SMSG_CLEAR_TARGET,                 "SMSG_CLEAR_TARGET",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3BF*/  StoreOpcode(CMSG_BOT_DETECTED,                 "CMSG_BOT_DETECTED",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x3C4*/  StoreOpcode(SMSG_KICK_REASON,                  "SMSG_KICK_REASON",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3C5*/  StoreOpcode(MSG_RAID_READY_CHECK_FINISHED,     "MSG_RAID_READY_CHECK_FINISHED",    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRaidReadyCheckFinishedOpcode);
    /*0x3CF*/  StoreOpcode(CMSG_TARGET_CAST,                  "CMSG_TARGET_CAST",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x3D0*/  StoreOpcode(CMSG_TARGET_SCRIPT_CAST,           "CMSG_TARGET_SCRIPT_CAST",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x3D1*/  StoreOpcode(CMSG_CHANNEL_DISPLAY_LIST,         "CMSG_CHANNEL_DISPLAY_LIST",        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelDisplayListQueryOpcode);
    /*0x3D3*/  StoreOpcode(CMSG_GET_CHANNEL_MEMBER_COUNT,     "CMSG_GET_CHANNEL_MEMBER_COUNT",    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGetChannelMemberCountOpcode);
    /*0x3D4*/  StoreOpcode(SMSG_CHANNEL_MEMBER_COUNT,         "SMSG_CHANNEL_MEMBER_COUNT",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3D7*/  StoreOpcode(CMSG_DEBUG_LIST_TARGETS,           "CMSG_DEBUG_LIST_TARGETS",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x3D8*/  StoreOpcode(SMSG_DEBUG_LIST_TARGETS,           "SMSG_DEBUG_LIST_TARGETS",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3DC*/  StoreOpcode(CMSG_PARTY_SILENCE,                "CMSG_PARTY_SILENCE",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x3DD*/  StoreOpcode(CMSG_PARTY_UNSILENCE,              "CMSG_PARTY_UNSILENCE",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x3DE*/  StoreOpcode(MSG_NOTIFY_PARTY_SQUELCH,          "MSG_NOTIFY_PARTY_SQUELCH",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x3DF*/  StoreOpcode(SMSG_COMSAT_RECONNECT_TRY,         "SMSG_COMSAT_RECONNECT_TRY",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3E0*/  StoreOpcode(SMSG_COMSAT_DISCONNECT,            "SMSG_COMSAT_DISCONNECT",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3E1*/  StoreOpcode(SMSG_COMSAT_CONNECT_FAIL,          "SMSG_COMSAT_CONNECT_FAIL",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3EE*/  StoreOpcode(CMSG_SET_CHANNEL_WATCH,            "CMSG_SET_CHANNEL_WATCH",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetChannelWatchOpcode);
    /*0x3EF*/  StoreOpcode(SMSG_USERLIST_ADD,                 "SMSG_USERLIST_ADD",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3F0*/  StoreOpcode(SMSG_USERLIST_REMOVE,              "SMSG_USERLIST_REMOVE",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3F1*/  StoreOpcode(SMSG_USERLIST_UPDATE,              "SMSG_USERLIST_UPDATE",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3F2*/  StoreOpcode(CMSG_CLEAR_CHANNEL_WATCH,          "CMSG_CLEAR_CHANNEL_WATCH",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x3F4*/  StoreOpcode(SMSG_GOGOGO_OBSOLETE,              "SMSG_GOGOGO_OBSOLETE",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3F5*/  StoreOpcode(SMSG_ECHO_PARTY_SQUELCH,           "SMSG_ECHO_PARTY_SQUELCH",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3F7*/  StoreOpcode(CMSG_SPELLCLICK,                   "CMSG_SPELLCLICK",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x3F8*/  StoreOpcode(SMSG_LOOT_LIST,                    "SMSG_LOOT_LIST",                   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x3FE*/  StoreOpcode(MSG_GUILD_EVENT_LOG_QUERY,         "MSG_GUILD_EVENT_LOG_QUERY",        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildEventLogQueryOpcode);
    /*0x3FF*/  StoreOpcode(CMSG_MAELSTROM_RENAME_GUILD,       "CMSG_MAELSTROM_RENAME_GUILD",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x400*/  StoreOpcode(CMSG_GET_MIRRORIMAGE_DATA,         "CMSG_GET_MIRRORIMAGE_DATA",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x401*/  StoreOpcode(SMSG_MIRRORIMAGE_DATA,             "SMSG_MIRRORIMAGE_DATA",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x402*/  StoreOpcode(SMSG_FORCE_DISPLAY_UPDATE,         "SMSG_FORCE_DISPLAY_UPDATE",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x403*/  StoreOpcode(SMSG_SPELL_CHANCE_RESIST_PUSHBACK, "SMSG_SPELL_CHANCE_RESIST_PUSHBACK", STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x404*/  StoreOpcode(CMSG_IGNORE_DIMINISHING_RETURNS_CHEAT,  "CMSG_IGNORE_DIMINISHING_RETURNS_CHEAT",   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x405*/  StoreOpcode(SMSG_IGNORE_DIMINISHING_RETURNS_CHEAT,  "SMSG_IGNORE_DIMINISHING_RETURNS_CHEAT",   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x406*/  StoreOpcode(CMSG_KEEP_ALIVE,                   "CMSG_KEEP_ALIVE",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess);
    /*0x407*/  StoreOpcode(SMSG_RAID_READY_CHECK_ERROR,       "SMSG_RAID_READY_CHECK_ERROR",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x408*/  StoreOpcode(CMSG_OPT_OUT_OF_LOOT,              "CMSG_OPT_OUT_OF_LOOT",             STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleOptOutOfLootOpcode);
    /*0x40B*/  StoreOpcode(CMSG_SET_GRANTABLE_LEVELS,         "CMSG_SET_GRANTABLE_LEVELS",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x40C*/  StoreOpcode(CMSG_GRANT_LEVEL,                  "CMSG_GRANT_LEVEL",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x40F*/  StoreOpcode(CMSG_DECLINE_CHANNEL_INVITE,       "CMSG_DECLINE_CHANNEL_INVITE",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x410*/  StoreOpcode(CMSG_GROUPACTION_THROTTLED,        "CMSG_GROUPACTION_THROTTLED",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x411*/  StoreOpcode(SMSG_OVERRIDE_LIGHT,               "SMSG_OVERRIDE_LIGHT",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x412*/  StoreOpcode(SMSG_TOTEM_CREATED,                "SMSG_TOTEM_CREATED",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x413*/  StoreOpcode(CMSG_TOTEM_DESTROYED,              "CMSG_TOTEM_DESTROYED",             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTotemDestroyed);
    /*0x414*/  StoreOpcode(CMSG_EXPIRE_RAID_INSTANCE,         "CMSG_EXPIRE_RAID_INSTANCE",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x415*/  StoreOpcode(CMSG_NO_SPELL_VARIANCE,            "CMSG_NO_SPELL_VARIANCE",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x416*/  StoreOpcode(CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY,  "CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY",   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverStatusMultipleQuery);
    /*0x417*/  StoreOpcode(SMSG_QUESTGIVER_STATUS_MULTIPLE,   "SMSG_QUESTGIVER_STATUS_MULTIPLE",  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x41A*/  StoreOpcode(CMSG_QUERY_SERVER_BUCK_DATA,       "CMSG_QUERY_SERVER_BUCK_DATA",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x41B*/  StoreOpcode(CMSG_CLEAR_SERVER_BUCK_DATA,       "CMSG_CLEAR_SERVER_BUCK_DATA",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x41C*/  StoreOpcode(SMSG_SERVER_BUCK_DATA,             "SMSG_SERVER_BUCK_DATA",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x41D*/  StoreOpcode(SMSG_SEND_UNLEARN_SPELLS,          "SMSG_SEND_UNLEARN_SPELLS",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x41E*/  StoreOpcode(SMSG_PROPOSE_LEVEL_GRANT,          "SMSG_PROPOSE_LEVEL_GRANT",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x41F*/  StoreOpcode(CMSG_ACCEPT_LEVEL_GRANT,           "CMSG_ACCEPT_LEVEL_GRANT",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    /*0x420*/  StoreOpcode(SMSG_REFER_A_FRIEND_FAILURE,       "SMSG_REFER_A_FRIEND_FAILURE",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*0x423*/  StoreOpcode(SMSG_SUMMON_CANCEL,                "SMSG_SUMMON_CANCEL",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
